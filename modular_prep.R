...
'/mnt/SERVER-CRCT-STORAGE/CRCT13/99PoleTechno/BioInformatique/CITE_seq/2021_CellRanger_Citeseq_NC01/H24b/outs/filtered_feature_bc_matrix',
'/mnt/SERVER-CRCT-STORAGE/CRCT13/99PoleTechno/BioInformatique/CITE_seq/2021_CellRanger_Citeseq_NC01/H24m/outs/filtered_feature_bc_matrix',
'/mnt/SERVER-CRCT-STORAGE/CRCT13/99PoleTechno/BioInformatique/CITE_seq/2021_CellRanger_Citeseq_NC01/H25b/outs/filtered_feature_bc_matrix',
'/mnt/SERVER-CRCT-STORAGE/CRCT13/99PoleTechno/BioInformatique/CITE_seq/2021_CellRanger_Citeseq_NC01/H25m/outs/filtered_feature_bc_matrix',
...
'/mnt/SERVER-CRCT-STORAGE/CRCT13/99PoleTechno/BioInformatique/CITE_seq/2021_CellRanger_Citeseq_NC01/H27b/outs/filtered_feature_bc_matrix',
'/mnt/SERVER-CRCT-STORAGE/CRCT13/99PoleTechno/BioInformatique/CITE_seq/2021_CellRanger_Citeseq_NC01/H27m/outs/filtered_feature_bc_matrix',
'/mnt/SERVER-CRCT-STORAGE/CRCT13/99PoleTechno/BioInformatique/CITE_seq/2021_CellRanger_Citeseq_NC01/H28b/outs/filtered_feature_bc_matrix',
'/mnt/SERVER-CRCT-STORAGE/CRCT13/99PoleTechno/BioInformatique/CITE_seq/2021_CellRanger_Citeseq_NC01/H28m/outs/filtered_feature_bc_matrix',
'/mnt/SERVER-CRCT-STORAGE/CRCT13/99PoleTechno/BioInformatique/CITE_seq/2021_CellRanger_Citeseq_NC01/H29b/outs/filtered_feature_bc_matrix',
'/mnt/SERVER-CRCT-STORAGE/CRCT13/99PoleTechno/BioInformatique/CITE_seq/2021_CellRanger_Citeseq_NC01/H29m/outs/filtered_feature_bc_matrix',
'/mnt/SERVER-CRCT-STORAGE/CRCT13/99PoleTechno/BioInformatique/CITE_seq/2021_CellRanger_Citeseq_NC01/H30b/outs/filtered_feature_bc_matrix',
'/mnt/SERVER-CRCT-STORAGE/CRCT13/99PoleTechno/BioInformatique/CITE_seq/2021_CellRanger_Citeseq_NC01/H30m/outs/filtered_feature_bc_matrix',
...
'/mnt/SERVER-CRCT-STORAGE/CRCT13/99PoleTechno/BioInformatique/CITE_seq/2021_CellRanger_Citeseq_NC01/T24832b/outs/filtered_feature_bc_matrix',
'/mnt/SERVER-CRCT-STORAGE/CRCT13/99PoleTechno/BioInformatique/CITE_seq/2021_CellRanger_Citeseq_NC01/T24832m/outs/filtered_feature_bc_matrix',
'/mnt/SERVER-CRCT-STORAGE/CRCT13/99PoleTechno/BioInformatique/CITE_seq/2021_CellRanger_Citeseq_NC01/T25370b/outs/filtered_feature_bc_matrix',
'/mnt/SERVER-CRCT-STORAGE/CRCT13/99PoleTechno/BioInformatique/CITE_seq/2021_CellRanger_Citeseq_NC01/T25370m/outs/filtered_feature_bc_matrix',
'/mnt/SERVER-CRCT-STORAGE/CRCT13/99PoleTechno/BioInformatique/CITE_seq/2021_CellRanger_Citeseq_NC01/T25446b/outs/filtered_feature_bc_matrix',
'/mnt/SERVER-CRCT-STORAGE/CRCT13/99PoleTechno/BioInformatique/CITE_seq/2021_CellRanger_Citeseq_NC01/T25446m/outs/filtered_feature_bc_matrix',
'/mnt/SERVER-CRCT-STORAGE/CRCT13/99PoleTechno/BioInformatique/CITE_seq/2021_CellRanger_Citeseq_NC01/T26029b/outs/filtered_feature_bc_matrix',
'/mnt/SERVER-CRCT-STORAGE/CRCT13/99PoleTechno/BioInformatique/CITE_seq/2021_CellRanger_Citeseq_NC01/T26029m/outs/filtered_feature_bc_matrix',
'/mnt/SERVER-CRCT-STORAGE/CRCT13/99PoleTechno/BioInformatique/CITE_seq/2021_CellRanger_Citeseq_NC01/T26305b/outs/filtered_feature_bc_matrix',
'/mnt/SERVER-CRCT-STORAGE/CRCT13/99PoleTechno/BioInformatique/CITE_seq/2021_CellRanger_Citeseq_NC01/T26305m/outs/filtered_feature_bc_matrix',
'/mnt/SERVER-CRCT-STORAGE/CRCT13/99PoleTechno/BioInformatique/CITE_seq/2021_CellRanger_Citeseq_NC01/T26625b/outs/filtered_feature_bc_matrix',
'/mnt/SERVER-CRCT-STORAGE/CRCT13/99PoleTechno/BioInformatique/CITE_seq/2021_CellRanger_Citeseq_NC01/T26625m/outs/filtered_feature_bc_matrix')
...
batch_1 <-c(
  ...
  '/mnt/SERVER-CRCT-STORAGE/CRCT13/99PoleTechno/BioInformatique/CITE_seq/2021_CellRanger_Citeseq_NC01/T23833b/outs/filtered_feature_bc_matrix',
  '/mnt/SERVER-CRCT-STORAGE/CRCT13/99PoleTechno/BioInformatique/CITE_seq/2021_CellRanger_Citeseq_NC01/T23833m/outs/filtered_feature_bc_matrix')
batch_1 <- basename(dirname(dirname(batch_1)))
...
tmp_seurat$batch = ifelse(test = name_of_samples[i] %in% batch_1,yes = "batch_1",no = "batch_2")
rm(tmp)
...
repeat {
  ...
  tmp_seurat <- CreateSeuratObject(counts = tmp[["Gene Expression"]], min.cells = 3, min.features = 200, project = name_of_samples[i])
  tmp_seurat <- NormalizeData(tmp_seurat)
  ###### Cleaning `TotalSeqB` tag name from the prospective ADT data
  rownames(tmp[["Antibody Capture"]])<- stringr::str_replace_all(rownames(tmp[["Antibody Capture"]]),
                                                                 setNames("", "_*TotalSeqB"));
  ###### Adding ADT modality to Seurat object 
  tmp_seurat[["ADT"]] <- CreateAssayObject(tmp[["Antibody Capture"]][, colnames(x = tmp_seurat)])
...
SaveH5Seurat(pbmc.combined,verbose = T,filename = 'raw_pbmc_combined.h5seurat')
# download refernce PBMC from here ;
